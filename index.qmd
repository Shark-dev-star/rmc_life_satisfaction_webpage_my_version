...
author: "MWEBEMBEZI JOHN FISHER" # Remember to add your name!
theme: morphy
---
...
# 2. Filter the `cantril` data frame to adjust the years 2011 and 2023.
...
Cantril_plot <- cantril %>% 
  filter(Country %in% c("South Africa","Nigeria","Algeria","Asia"))%>% 
  ggplot(aes(x = Year , y = `Cantril ladder score`, colour = Country, fill = Country)) +
  geom_line()+ 
  scale_y_continuous(limits = c(0,10) ) +
  labs(x = "Year" , y = "Cantril Ladder Score", colour = "Country")+
  theme_minimal()
